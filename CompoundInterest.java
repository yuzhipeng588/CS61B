...
//Zhipeng
        ...
        if(numYears(targetYear)==-1){
          ...
          for(int i=-1;i<numYears(targetYear);i++){
              Newrate*=(1+rate/100)*(100-inflationRate)/100;
          }
        return presentValue*Newrate;
        }
//Zhipeng
...
//Zhipeng
        ...
        if(numYears(targetYear)==-1){
          ...
          for(int i=-1;i<numYears(targetYear);i++){
                savings+=futureValue(perYear,rate,THIS_YEAR+i+2);
          }
        return savings;
        }
//Zhipeng
...
//Zhipeng
        ...
        if(numYears(targetYear)==-1){
          ...
          for(int i=-1;i<numYears(targetYear);i++){
                savings+=futureValueReal(perYear,rate,THIS_YEAR+i+2,inflationRate);
          }
        return savings;
        }
//Zhipeng
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = futureValue(PER_YEAR, returnRate,
                              targetYear); // replace 0 with your code
        double realDollarValue = futureValueReal(PER_YEAR, returnRate,
                                  targetYear, inflationRate);    // replace 0 with your code
