...
//Zhipeng
        ...
        start-=1;
        return subTail(L.tail,start);  // REPLACE WITH YOUR SOLUTION
        }
//Zhipeng
    }
...
//Zhipeng
        if(start==0||L==null){
            if(len==0||L==null){ 
             ...
             len-=1;
             return new IntList(L.head,sublist(L.tail,start,len));
             }
        }
        else{
        start-=1;
        IntList L0=sublist(L.tail,start,len);
        return L0;  // REPLACE WITH YOUR SOLUTION
        }
//Zhipeng
    }
...
//Zhipeng
        ...
        if(start==0||L==null){
            if(len==0||L==null){ 
             ...
             len-=1;
             L.tail=dsublist(L.tail,start,len);
             return L;
             }
        }
        else{
        start-=1;
        L.tail=dsublist(L.tail,start,len);
        return L.tail;  // REPLACE WITH YOUR SOLUTION
        }
//Zhipeng
